...
namespace Client.ServiceReference {
    ...
    public interface ILibraryService {
        ...
        Client.ServiceReference.Book[] getListOfBorrowedItems();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ILibraryService/getListOfBorrowedItems", ReplyAction="http://tempuri.org/ILibraryService/getListOfBorrowedItemsResponse")]
        System.Threading.Tasks.Task<Client.ServiceReference.Book[]> getListOfBorrowedItemsAsync();
        ...
        Client.ServiceReference.Book[] getBorrowedBooks(int userID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ILibraryService/getBorrowedBooks", ReplyAction="http://tempuri.org/ILibraryService/getBorrowedBooksResponse")]
        System.Threading.Tasks.Task<Client.ServiceReference.Book[]> getBorrowedBooksAsync(int userID);
        ...
        Client.ServiceReference.Status borrowBook(int bookID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ILibraryService/borrowBook", ReplyAction="http://tempuri.org/ILibraryService/borrowBookResponse")]
        System.Threading.Tasks.Task<Client.ServiceReference.Status> borrowBookAsync(int bookID);
    }
    ...
    public partial class LibraryServiceClient : System.ServiceModel.ClientBase<Client.ServiceReference.ILibraryService>, Client.ServiceReference.ILibraryService {
        ...
        public Client.ServiceReference.Book[] getListOfBorrowedItems() {
            return base.Channel.getListOfBorrowedItems();
        }
        
        public System.Threading.Tasks.Task<Client.ServiceReference.Book[]> getListOfBorrowedItemsAsync() {
            return base.Channel.getListOfBorrowedItemsAsync();
        }
        
        public Client.ServiceReference.Book[] getBorrowedBooks(int userID) {
            return base.Channel.getBorrowedBooks(userID);
        }
        
        public System.Threading.Tasks.Task<Client.ServiceReference.Book[]> getBorrowedBooksAsync(int userID) {
        ...
        public Client.ServiceReference.Status borrowBook(int bookID) {
            return base.Channel.borrowBook(bookID);
        }
        
        public System.Threading.Tasks.Task<Client.ServiceReference.Status> borrowBookAsync(int bookID) {
            return base.Channel.borrowBookAsync(bookID);
        }
    }
}
